    ...
    <div class="section" id="intro" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="text-center">
          <h1 class="text_welcome hvr-float hvr-underline-from-left" id="son">BIOGRAPHY</h1>
        </div>
      </div>
      <div class="section" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="text-center">
            <h1 class="text_welcome hvr-float hvr-underline-from-left">BIOGRAPHY</h1>
          </div>
        </div>
    </div>
